...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $id=$_SESSION["id"];
     ...
     if(empty($mail_err)&&empty($password_err) &&empty($pin_err)){
        
        // Prepare an insert statement

        $sql="UPDATE `reguser` SET name='$name', emailid='$email_id', age='$age', mobilenumber1='$mobilenumber1', houseno='$hno', street='$street', city='$city', state='$state', pincode='$pin', password='$password' 
                WHERE id ='$id'";
...
<div class="content">
    ...
    <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="signup">
            ...
            <input type="email" id="emailid" name="emailid"  class="input-field" ><br>
       
            <label for="age">Age</label><br>
            <input type="int" id="age" name="age"  class="input-field" ><br>

            <label for="mobilenumber1">Mobile Number</label><br>
            <input type="tel" id="mobilenumber1" name="mobilenumber1"  class="input-field" ><br>

            <label for="houseno">House Number</label><br>
            <input type="int" id="houseno" name="houseno"  class="input-field" ><br>

            <label for="street">Street/Area</label><br>
            <input type="text" id="street" name="street"  class="input-field" ><br>

            <label for="city">City</label><br>
            <input type="text" id="city" name="city"  class="input-field" ><br>

            <label for="state">State</label><br>
            <input type="text" id="state" name="state"  class="input-field" ><br>

            <label for="pincode">Pincode</label><?php echo (!empty($pin_err)) ? $pin_err : ''; ?><br>
            <input type="int" id="pincode" name="pincode"  class="input-field" ><br>
