...
<div class="row">
        <div class="col-md-6 col-lg-6 col-sm-16 col-xs-16">
                ...
                <h4 style="color:black"><i class="fa fa-hospital-o"></i>Hospita Id:<?php echo htmlspecialchars($_SESSION["hos_id"])?>, Doctor Id:<?php echo htmlspecialchars($_SESSION["doc_id"])?> </h4>
