...
if (isset($_POST['submit'])){
    ...
    $today = date("Y-m-d");
    if(STRCMP($today, $_SESSION["slotdate"]) < 0 || $_SESSION["slotdate"] == NULL){
      echo "<script>alert('Not Vaccinated Yet, Please give feedback after getting vaccinated');document.location.href=('userhome.php');</script>";
    }
    // $name=$_SESSION["name"];
